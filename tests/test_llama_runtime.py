...
class LlamaRuntimeTests(unittest.TestCase):
    def test_discovers_nvidia_wheel_layouts_without_importing_cuda(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                patch.object(llama_runtime.sysconfig, "get_path", return_value=str(library)),
    ...
    def test_prepares_both_search_mechanisms_and_retains_handles(self) -> None:
        ...
        with (
            ...
            patch.object(llama_runtime, "cuda_dll_directories", return_value=[directory]),
            patch.object(llama_runtime.os, "add_dll_directory", return_value=handle) as register,
