...
class RuntimePreflightTests(unittest.TestCase):
    def test_outside_managed_environment_explains_activation_when_venv_exists(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            python.touch()
            with (
                patch.object(runtime, "in_managed_virtual_environment", return_value=False),
