...
class MainWindow(QMainWindow):
    ...
    def send(self, prompt: str) -> None:
        ...
        self._assistant_bubble = self.chat.add_message("assistant", "")
    ...
    def _finished(self, stats: dict[str, object]) -> None:
        ...
        self.chat.generating(False); self._assistant_bubble = None

    def _failed(self, error: str) -> None:
        LOG.error("%s", error)
        self.chat.stats.setText(error); self.chat.generating(False); self._assistant_bubble = None
